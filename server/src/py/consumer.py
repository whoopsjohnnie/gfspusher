...
# 
# https://raw.githubusercontent.com/pika/pika/master/examples/asyncio_consumer_example.py
# 
...
class ExampleConsumer(object):
    ...
    """
    EXCHANGE = 'gfs-exchange' # 'message'
    EXCHANGE_TYPE = 'topic' # 'topic'
    QUEUE = "0001" + '-' + "gfs1" # 'text'
    ROUTING_KEY = "gfs1.info" # 'example.text'
